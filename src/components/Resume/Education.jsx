...
const Education = () => {
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:2, transition:{duration:2}}} className="w-full flex gap-20">
        <div>
          <div className="py-20 font-titleFont">
            <p className="text-sm text-designColor tracking-[4px]">2008-2023</p>
            <h2 className="text-4xl font-bold">Education Quality</h2>
          </div>
          <div className="mt-3 w-full h-[1000px] border-1-[6px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
            <ResumeCard
