...
const ProjectCards = ({title, des, src }) => {
  return (
    <div className="w-full px-12 h-auto py-10 rounded-lg shadow-shadowOne  flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:bg-gray-900 transition-colors duration-1000">
      <div className="lg:w-full lg:h-[80%] overflow-hidden rounded-md sm:size-33 ">
      ...
      <div className="w-full mt-5 flex flex-col gap-6">
        ...
        <div className="flex gap-3 ml-3">
           <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-designColor duration-300 cursor-pointer"><BsGithub/></span>
